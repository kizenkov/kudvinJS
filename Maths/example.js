function newExample(from, to) {
  ...
  let newExample = {
    ...
    create: function (id) {
      ...
      this.a = Math.trunc(Math.random() * (to - 1) + from);
      this.b = Math.trunc(Math.random() * (to - 1) + from);
      let c = Math.trunc(Math.random() * (to - 1) + from);
      let d = Math.trunc(Math.random() * (to - 1) + from);
